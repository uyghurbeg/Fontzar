...
// Font
NSString *kDefaultFont = @"UKIJ Ekran";
NSString *kButtonFont = @"UKIJ Ekran";
...
-(void)viewWillLayoutSubviews
{
    ...
    else
    {
        ...
        r = CGRectMake((sz.width-kWindowWidth)/2, -kWindowHeight - 100, kWindowWidth, kWindowHeight);
    }
    
    self.view.frame = r;
    _contentView.frame = CGRectMake(0.0f, (kCircleHeight / 4) - 100, kWindowWidth, kWindowHeight);
    _circleViewBackground.frame = CGRectMake(kWindowWidth / 2 - kCircleHeightBackground / 2, kCircleBackgroundTopPosition - 100, kCircleHeightBackground, kCircleHeightBackground);
    _circleViewBackground.layer.cornerRadius = _circleViewBackground.frame.size.height / 2;
    _circleView.frame = CGRectMake(kWindowWidth / 2 - kCircleHeight / 2, kCircleTopPosition - 100, kCircleHeight, kCircleHeight);
...
-(SCLAlertViewResponder *)showTitle:(UIViewController *)vc title:(NSString *)title subTitle:(NSString *)subTitle duration:(NSTimeInterval)duration completeText:(NSString *)completeText style:(SCLAlertViewStyle)style
{
    ...
    switch (style)
    {
        ...
        case Edit:
            viewColor = [UIColor colorWithRed:0.29 green:0.30 blue:0.29 alpha:1.00];
    ...
    [UIView animateWithDuration:0.2f animations:^{
        ...
        frame.origin.y = self.rootViewController.view.center.y - 200.0f;
